                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <router-link :to="{ name: 'questions' }"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <a href="">
                                <font-awesome-icon icon="fa-solid fa-circle-question" class="text-gray-500" />
                            </a>
                    ...
                    <li>
                        <router-link :to="{ name: 'orders' }"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <a href="">
                                 <font-awesome-icon icon="fa-solid fa-truck-fast" class="text-gray-500"/>
                            </a>
                            <span class="ms-3">Orders</span>
                        </router-link>
                    </li>
                    <li>
                        <router-link :to="{ name: 'answers' }"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <a href="">
                                <font-awesome-icon icon="fa-solid fa-comments" class="text-gray-500" />
                            </a>
